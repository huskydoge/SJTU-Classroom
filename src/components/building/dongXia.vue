<template>
  ...
  <div v-if="showPage" style="display: flex">
    <div
      ...
      "
    >
      <h1 style="font-size: 3.5rem"> 东下院 </h1>
      <!-- 教学楼图片 -->
      ...
      >
        ...
        <baidu-map v-if="map" :points="[121.443441,31.030695]"></baidu-map>
      </div>
      <!-- 教学楼自习教室 -->
      <div
          :ref="tabs[3].refName"
...
export default {
  ...
  data() {
    return {
      ...
      four:[],
      five:[],
      imgList: ['static/pictures/dongxia/dongxia.jpg','static/pictures/dongxia/dongxia1.jpg'],

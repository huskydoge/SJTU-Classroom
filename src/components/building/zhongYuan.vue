<template>
  ...
  <div v-if="showPage" style="display: flex">
    <div
      ...
      "
    >
      <h1 style="font-size: 3.5rem"> 中院 </h1>
      <!-- 教学楼图片 -->
      ...
      >
        ...
        <baidu-map v-if="map" :points="[121.437753,31.026796]"></baidu-map>
      </div>
      <!-- 教学楼自习教室 -->
      <div
          :ref="tabs[3].refName"
...
export default {
  ...
  data() {
    return {
      ...
      four:[],
      five:[],
      imgList:['static/pictures/zhongyuan/zhongyuan1.jpg','static/pictures/zhongyuan/zhongyuan2.jpg','static/pictures/zhongyuan/zhongyuan3.jpg'],
